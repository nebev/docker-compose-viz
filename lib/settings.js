  ...
  async getComposePath() {
    ...
    if (localOverrideExists) {
      ...
      if (localOverride.composePath) {
        const localOverrideComposePathExists = await this._fileExists(`${this.localDirectory}/${localOverride.composePath}`);
        ...
        return `${this.localDirectory}/${localOverride.composePath}`;
      }
    }
